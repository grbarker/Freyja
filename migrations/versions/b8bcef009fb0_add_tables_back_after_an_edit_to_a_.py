"""Add tables back after an edit to a column in Product table. Edit added scale and asdecimal parameters to Numeric data type.

Revision ID: b8bcef009fb0
Revises: a5fd08db3e3f
Create Date: 2018-12-10 13:44:54.240915
...
revision = 'b8bcef009fb0'
down_revision = 'a5fd08db3e3f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_index(op.f('ix_user_customername'), 'user', ['customername'], unique=False)
    ...
    op.create_index(op.f('ix_user_postalcode'), 'user', ['postalcode'], unique=False)
